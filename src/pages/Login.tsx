          ...
          <div className="space-y-6">
            <div className="text-center">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                Sign in with your Discord account to access the BotTrapper
                dashboard. You'll need manage permissions on servers where the
                bot is installed.
              </p>
            </div>
            ...
            <div className="mt-6">
              <div className="text-xs text-gray-500 dark:text-gray-400 text-center space-y-2">
                ...
                <p>
                  Only users with "Manage Guild" permissions can access the
                  dashboard.
                </p>
              </div>
            </div>
