        ...
        <div className="bg-white dark:bg-gray-800 py-8 px-4 shadow-lg border border-gray-200 dark:border-gray-700 sm:rounded-lg sm:px-10">
          ...
          <div className="space-y-6">
            <div className="text-center">
              <div className="mb-6">
                <svg className="mx-auto h-16 w-16" viewBox="0 0 71 55" fill="none">
              ...
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-6">
                Sign in with your Discord account to access the BotTrapper dashboard. You'll need manage permissions on servers where the bot is installed.
              </p>
            </div>
            ...
            >
              ...
              <ArrowRightIcon className="ml-3 h-4 w-4 group-hover:translate-x-1 transition-transform" />
            </button>
            ...
            <div className="mt-6">
              <div className="text-xs text-gray-500 dark:text-gray-400 text-center space-y-2">
                ...
                <p>
                  Only users with "Manage Guild" permissions can access the dashboard.
                </p>
              </div>
            </div>
          </div>
